...
if (isset($_REQUEST['btn_calcular']))
{
    ...
    $Medida=$_REQUEST['rb_medida']*$Tiempo;
// en minutos en el html ponemos value=1 y en horas value=60, para que cuente que son minutos todo y lo que señalemos sea el valor de minuto u hora
